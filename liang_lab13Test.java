...
public class liang_lab13Test {
	...
	public void setUp() throws Exception 
	{
		...
		try
		{
			...
			ArrayList<Integer> intTest1 = testData.get(0);
			for( int i = 0; i < testData.get(0).size(); i++ )
			{
				expectedResult1[i] = intTest1.get(i);
			}
			...
			ArrayList<Integer> intTest2 = testData.get(1);
			for( int i = 0; i < testData.get(1).size(); i++ )
			{
				expectedResult2[i] = intTest2.get(i);
			}
			...
			ArrayList<Integer> intTest3 = testData.get(2);
			for( int i = 0; i < testData.get(2).size(); i++ )
			{
				expectedResult3[i] = intTest3.get(i);
			}
	...
	public void testGetResult3() {
		assertArrayEquals(expectedResult3, lab.getResults3());
	}
